...
(function () {
  ...
  if (window.CanvasRenderingContext2D) {
     ...
     */
    CanvasRenderingContext2D.prototype.drawPokerCard = function (
      x,
      y,
      size,
      suit,
     ...
     */
    CanvasRenderingContext2D.prototype.drawPokerBack = function (
      x,
      y,
      size,
      foregroundColor,
     ...
     */
    CanvasRenderingContext2D.prototype.svgCurve = function (
      x,
      y,
      size,
      svgPath
     ...
     */
    CanvasRenderingContext2D.prototype.drawPokerSymbol = function (
      x,
      y,
      size,
      symbol
     ...
     */
    CanvasRenderingContext2D.prototype.strokePokerSymbol = function (
      x,
      y,
      size,
      symbol
     ...
     */
    CanvasRenderingContext2D.prototype.fillPokerSymbol = function (
      x,
      y,
      size,
      symbol
     ...
     */
    CanvasRenderingContext2D.prototype.drawPokerCrown = function (
      x,
      y,
      size,
      startColor,
    ...
    window.Poker = {
      ...
      getBackCanvas: function (size, foregroundColor, backgroundColor) {
        ...
        canvas
          .getContext("2d")
          .drawPokerBack(0, 0, size, foregroundColor, backgroundColor);
        return canvas;
      },
